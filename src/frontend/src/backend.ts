...
export class Backend implements backendInterface {
    ...
    async getBookmarkedLessonIds(): Promise<Array<bigint>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBookmarkedLessonIds();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLessonById(arg0: bigint): Promise<Lesson | null> {
        if (this.processError) {
            try {
    ...
    async getLessonsByCategory(arg0: bigint): Promise<Array<Lesson>> {
        if (this.processError) {
            try {
    ...
    async searchLessons(arg0: string): Promise<Array<Lesson>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchLessons(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
